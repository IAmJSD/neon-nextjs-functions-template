  ...
  return (
    <main className="flex min-h-[calc(100vh-72px)] items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div>
          <p className="text-sm font-medium text-emerald-700 dark:text-emerald-300">Welcome back</p>
        ...
        <div className="mt-5 text-center text-sm text-slate-500 dark:text-slate-400">
          Need an account?{' '}
          <Link href="/auth/sign-up" className="font-medium text-slate-950 hover:underline dark:text-slate-50">
            Sign up
          </Link>
        </div>
      </form>
